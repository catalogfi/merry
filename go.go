...
func (m *Merry) Start() error {
	...
	bashCmd := runDockerCompose(composePath, "up", "-d", "esplora", "ethereum-explorer", "arbitrum-explorer", "nginx", "garden-evm-watcher", "garden-db", "quote", "bit-ponder", "cobiv2", "relayer", "bit-indexer", "authenticator", "orderbookV2", "info", "rippled", "starknet-devnet", "garden-starknet-watcher", "starknet-relayer", "starknet-executor", "garden-kiosk")
